  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <h2 className="text-2xl font-bold font-space text-zinc-100">Create Account</h2>
        <p className="text-sm text-zinc-500 mt-1">Get started with Liber AI companion</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
        {error && (
          <div className="p-3 text-xs rounded-lg border border-red-500/20 bg-red-500/5 text-red-400 font-medium animate-pulse">
            {error}
          </div>
        )}
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="e.g. cyber_traveler"
              disabled={isLoading}
            />
          </div>
        </div>
        ...
        <Button
          type="submit"
          className="w-full h-11 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white font-semibold shadow-[0_0_20px_rgba(168,85,247,0.3)] border border-purple-500/20 transition-all duration-300 gap-2 mt-2"
          disabled={isLoading}
        >
          {isLoading ? (
            <>
      ...
      <div className="mt-6 relative z-10">
        <div className="relative flex py-2 items-center">
          ...
          <span className="flex-shrink mx-4 text-zinc-500 text-[10px] uppercase font-mono tracking-wider">Or Sign up with</span>
          <div className="flex-grow border-t border-white/5"></div>
        </div>

        <div className="grid grid-cols-2 gap-4 mt-2">
          <button className="flex items-center justify-center gap-2 h-10 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-xs text-zinc-200 transition-all hover:border-purple-500/30">
          ...
          <button className="flex items-center justify-center gap-2 h-10 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-xs text-zinc-200 transition-all hover:border-blue-500/30">
            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
